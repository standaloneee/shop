...
import ru.shop.security.jwt.JwtAuthentication;
import ru.shop.security.jwt.JwtProvider;
...
public class AuthService {
    ...
    public JwtResponse login(@NonNull JwtRequest authRequest) throws AuthException {
        final Customer user = customerService.getByLogin(authRequest.getLogin())
    ...
    public JwtResponse getAccessToken(@NonNull String refreshToken) throws AuthException {
        if (jwtProvider.validateRefreshToken(refreshToken)) {
            ...
            if (saveRefreshToken != null && saveRefreshToken.equals(refreshToken)) {
                final Customer user = customerService.getByLogin(login)
                        .orElseThrow(() -> new AuthException("Пользователь не найден"));
                final String accessToken = jwtProvider.generateAccessToken(user);
